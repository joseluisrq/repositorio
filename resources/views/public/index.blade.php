...
<head>
  ...
  <link href="{{asset("assets/public/asset/css/")}}/cslider.css" rel="stylesheet" />
  <link href="{{asset("assets/public/asset/css/")}}/style.css" rel="stylesheet" />
  <!-- Theme skin -->
  <link id="t-colors" href="{{asset("assets/public/asset/skins/")}}/default.css" rel="stylesheet" />
  <!-- boxed bg 
          ...
          <div class="row">
            <div class="span12">
              <ul>
                ...
                <li>Direccion</li>
                <li>Telefono <i class="icon-phone"></i> (123) 456-7890 - (123) 555-7891</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="span12">
              <div class="headnav">
                <ul>                 
                  <li>     
                      <a href="{{ route('home') }}">
                        <i class="icon-user"></i>  Inicar Sesion</a>
                    </li>
                ...
                <div class="navigation">
                  <nav>
                    <ul class="nav topnav">
                      ...
                      <li>
                        <router-link to="/blog">Publicaciones</router-link>
                      </li>
                      <li>
...
<!--<script src="{{asset("assets/public/asset/js/")}}/modernizr.custom.28468.js"></script>-->
  <script src="{{asset("assets/public/asset/js/")}}/jquery.cslider.js"></script>
