...
//Route::get('/{anypatch}', 'HomeController@index')->name('path','.*');
/*Route::get('post', 'PostController@all_post');*/


Route::group(['middleware' => ['auth']], function () {
/*Categorias*/
Route::post('/add-category', 'CategoriaController@add_category');
Route::get('/category','CategoriaController@all_category');
Route::get('/category/{id}','CategoriaController@delete_category');
Route::get('editcategory/{id}','CategoriaController@edit_category');
Route::post('update-category/{id}','CategoriaController@update_category');
